...
async def get_report(
    ...
    try:
        ...
        ### Debit Transactions Percentage Split (For Given Month & Year)
        debit_pipeline = [
        ...
        ### Monthly Credit & Debit Sum (From Start of the Year to Current Month)
        monthly_pipeline = [
        ...
        ### Current Month's Total Transactions
        total_pipeline = [
            {"$match": {"username": user, "type": "Debit", "date": {"$gte": start_of_month.timestamp(), "$lte": end_of_month.timestamp()}}},
