...
var G__12327 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__12327,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12331 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__12331,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12335 = props;
var G__12335__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12335,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12335);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12335__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__12336 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12336,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__12336;
}
})(),id_class);
...
var G__12337 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12337) {
case (0):
...
var vec__12339 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12339,(0),null);
var id = cljs.core.nth.call(null,vec__12339,(1),null);
var className = cljs.core.nth.call(null,vec__12339,(2),null);
...
var temp__5827__auto___12342 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5827__auto___12342 == null)){
} else {
var key_12343 = temp__5827__auto___12342;
(jsprops.key = key_12343);
}
...
var temp__5827__auto___12344 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5827__auto___12344 == null)){
} else {
var key_12345 = temp__5827__auto___12344;
(jsprops.key = key_12345);
}
...
var temp__5827__auto___12346 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5827__auto___12346 == null)){
} else {
var key_12347 = temp__5827__auto___12346;
(jsprops.key = key_12347);
}
...
var temp__5827__auto___12348 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5827__auto___12348 == null)){
} else {
var key_12349 = temp__5827__auto___12348;
(jsprops.key = key_12349);
}
...
var temp__5827__auto___12350 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5827__auto___12350 == null)){
} else {
var key_12351 = temp__5827__auto___12350;
(jsprops.key = key_12351);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__12352_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__12352_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12353 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__12353,(0),null);
var derefed = cljs.core.nth.call(null,vec__12353,(1),null);
...
break;
default:
var G__12358 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__12359 = compiler;
v = G__12358;
compiler = G__12359;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12363 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12363 = (function (opts,id,fn_to_element,parse_fn,meta12364){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12363.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12365,meta12364__$1){
var self__ = this;
var _12365__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12363(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12364__$1));
}));

(reagent.impl.template.t_reagent$impl$template12363.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12365){
var self__ = this;
var _12365__$1 = this;
return self__.meta12364;
}));

(reagent.impl.template.t_reagent$impl$template12363.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12363.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12363.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template12363.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12363.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12363.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12364","meta12364",490152271,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12363.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12363.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12363");

(reagent.impl.template.t_reagent$impl$template12363.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write.call(null,writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12363");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12363.
 */
reagent.impl.template.__GT_t_reagent$impl$template12363 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12363(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12364){
return (new reagent.impl.template.t_reagent$impl$template12363(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12364));
});

}

return (new reagent.impl.template.t_reagent$impl$template12363(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
