...
var G__16412 = devtools.prefs.pref.call(null,v);
v = G__16412;
continue;
} else {
return v;
...
}catch (e16413){var _e__15478__auto__ = e16413;
return false;
}})();
...
}catch (e16415){var _e__15478__auto__ = e16415;
return false;
}})();
...
}catch (e16417){var _e__15478__auto__ = e16417;
return false;
}}
}
});
...
var vec__16419 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16419,(0),null);
var name = cljs.core.nth.call(null,vec__16419,(1),null);
...
return cljs.core.some.call(null,(function (p1__16422_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16422_SHARP_);
}),template);
});
