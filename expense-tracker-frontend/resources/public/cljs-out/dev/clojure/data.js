...
return cljs.core.reduce.call(null,(function (result,p__18910){
...
var vec__18914 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__18914,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__18914,(1),null);
var ab = cljs.core.nth.call(null,vec__18914,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_18920 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_18920.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_18921 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_18921.call(null,a,b);
}
});
...
return (function (){var G__18925 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__18925__$1)].join('')));
