...
var months = cljs.core.clj__GT_js.call(null,cljs.core.map.call(null,(function (p1__16033_SHARP_){
return cljs.core.get.call(null,expense_tracker_frontend.components.charts.month_names,cljs.core.name.call(null,p1__16033_SHARP_));
}),month_keys));
var credit_data = cljs.core.clj__GT_js.call(null,cljs.core.map.call(null,(function (p1__16034_SHARP_){
return cljs.core.get_in.call(null,new cljs.core.Keyword(null,"monthly_credit_debit","monthly_credit_debit",-676138370).cljs$core$IFn$_invoke$arity$1(report),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16034_SHARP_,new cljs.core.Keyword(null,"Credit","Credit",1550580027)], null),(0));
}),month_keys));
var debit_data = cljs.core.clj__GT_js.call(null,cljs.core.map.call(null,(function (p1__16035_SHARP_){
return cljs.core.get_in.call(null,new cljs.core.Keyword(null,"monthly_credit_debit","monthly_credit_debit",-676138370).cljs$core$IFn$_invoke$arity$1(report),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16035_SHARP_,new cljs.core.Keyword(null,"Debit","Debit",-2117693532)], null),(0));
}),month_keys));
