...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_12556);
...
var len__5726__auto___12560 = arguments.length;
var i__5727__auto___12561 = (0);
while(true){
if((i__5727__auto___12561 < len__5726__auto___12560)){
args__5732__auto__.push((arguments[i__5727__auto___12561]));

var G__12562 = (i__5727__auto___12561 + (1));
i__5727__auto___12561 = G__12562;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq12557){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12558,G__12559,seq12557__$2);
}));
...
var vec__12563 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__12563,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__12563,(1),null);
var G__12566 = cljs.core.PersistentArrayMap.EMPTY;
var G__12566__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__12566,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12566);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__12566__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__12566__$1;
}
} else {
...
return (function() { 
var G__12570__delegate = function (klass,contents){
var vec__12567 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__12567,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__12567,(1),null);
...
var G__12570 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__12571__i = 0, G__12571__a = new Array(arguments.length -  1);
while (G__12571__i < G__12571__a.length) {G__12571__a[G__12571__i] = arguments[G__12571__i + 1]; ++G__12571__i;}
  contents = new cljs.core.IndexedSeq(G__12571__a,0,null);
} 
return G__12570__delegate.call(this,klass,contents);};
G__12570.cljs$lang$maxFixedArity = 1;
G__12570.cljs$lang$applyTo = (function (arglist__12572){
var klass = cljs.core.first(arglist__12572);
var contents = cljs.core.rest(arglist__12572);
return G__12570__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__12576){
var map__12577 = p__12576;
var map__12577__$1 = cljs.core.__destructure_map.call(null,map__12577);
var ns = cljs.core.get.call(null,map__12577__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__12577__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__12578){
var map__12579 = p__12578;
var map__12579__$1 = cljs.core.__destructure_map.call(null,map__12579);
var actual = cljs.core.get.call(null,map__12579__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__12579__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
var node = cljs_test_display.core.div.call(null,new cljs.core.Keyword(null,"test-fail","test-fail",-1337227951),cljs_test_display.core.contexts_node.call(null),cljs_test_display.core.div.call(null,new cljs.core.Keyword(null,"fail-body","fail-body",91617623),(function (){var temp__5823__auto__ = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__12580){
var map__12581 = p__12580;
var map__12581__$1 = cljs.core.__destructure_map.call(null,map__12581);
var expected = cljs.core.get.call(null,map__12581__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__12581__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12582_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__12582_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__12584 = cljs_test_display.core.current_var_info.call(null);
var map__12584__$1 = cljs.core.__destructure_map.call(null,map__12584);
var info = map__12584__$1;
var name = cljs.core.get.call(null,map__12584__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__12584__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12584__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12583_SHARP_){
return cljs.core.cons.call(null,node,p1__12583_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__12585){
var map__12586 = p__12585;
var map__12586__$1 = cljs.core.__destructure_map.call(null,map__12586);
var m = map__12586__$1;
var fail = cljs.core.get.call(null,map__12586__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__12586__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__12586__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__12586__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5823__auto___12587 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___12587)){
var message_12588 = temp__5823__auto___12587;
cljs.core.println.call(null,message_12588);
} else {
}
...
var temp__5823__auto___12589 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___12589)){
var message_12590 = temp__5823__auto___12589;
cljs.core.println.call(null,message_12590);
} else {
}
