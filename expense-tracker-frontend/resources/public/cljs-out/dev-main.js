window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=af4e32&fwbuild=dev"};
...
document.write('<script>goog.require("expense_tracker_frontend.core");</script>');
